(function () {
    if (typeof document !== 'undefined') {
        var head = document.head || document.getElementsByTagName('head')[0],
            ...
            css = ".side-menu[data-v-326579fc] { position: absolute; top: 0; left: 0; bottom: 0; right: 0; overflow: hidden; } .menu-wrap[data-v-326579fc] { position: absolute; top: 0; bottom: 0; transform: translateZ(0); } .content-wrap[data-v-326579fc] { position: absolute; top: 0; right: 0; bottom: 0; left: 0; overflow: hidden; transform: translateZ(0); } .menu-mask[data-v-326579fc] { position: absolute; top: 0; right: 0; bottom: 0; left: 0; background-color: #000; z-index: 1000; } .moving[data-v-326579fc] { transition: transform 0.3s ease; } .will-change[data-v-326579fc] { will-change: transform; } ";style.type = 'text/css';if (style.styleSheet) {
