...
var DrawerLayout = {
  render: function render() {
    ...
    return _c('div', {staticClass: "drawer-layout"}, [_c('div', {
      staticClass: "drawer-wrap",
      class: {'moving': _vm.moving, 'will-change': _vm.willChange},
      style: {
        zIndex: _vm.zIndex,
        width: _vm.drawerWidth + 'px',
        left: '-' + Math.ceil(_vm.drawerWidth / 3) + 'px',
        transform: 'translate3d(' + Math.ceil(_vm.pos / 3) + 'px,0,0)'
      }
    }, [_vm._t("drawer")], 2), _vm._v(" "), _c('div', {
      staticClass: "content-wrap",
      class: {'moving': _vm.moving, 'will-change': _vm.willChange},
      style: _vm.contentDrawable ? {transform: 'translate3d(' + _vm.pos + 'px,0,0)'} : {}
    }, [_c('div', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: _vm.backdrop && _vm.pos,
        expression: "backdrop && pos"
      }], staticClass: "drawer-mask", style: {'opacity': _vm.backdropOpacity}, on: {"click": _vm.handleMaskClick}
    }), _vm._v(" "), _vm._t("content")], 2)]);
